...
let groupRespawnGroupsQuery = ecs.SqQuery("groupRespawnGroupsQuery", {
  comps_ro=[
  ...
  comps_rq=["autoRespawnSelector"]
})
let groupCustomRespawnGroupsQuery = ecs.SqQuery("groupCustomRespawnGroupsQuery", {
  comps_ro=[
    ["selectedGroup", ecs.TYPE_INT],
    ["transform", ecs.TYPE_MATRIX],
    ["respawnIconType", ecs.TYPE_STRING],
    ["team", ecs.TYPE_INT],
    ["respawn_point__respawnersQueue", ecs.TYPE_EID_LIST],
    ["respawn_icon__active", ecs.TYPE_BOOL]
  ],
  comps_no=["autoRespawnSelector", "mobileRespawnSelector"]
})
let teamAutoSpawnQuery = ecs.SqQuery("teamAutoSpawnQuery", {
  comps_ro=[["team__id", ecs.TYPE_INT]],
  comps_rw=[["team__lastAutoSpawnCapZoneEid", ecs.TYPE_EID], ["team__prevAutoSpawnCapZoneEid", ecs.TYPE_EID]]
})
...
let forceRespawnGroupsQuery = ecs.SqQuery("forceRespawnGroupsQuery", {
  comps_ro=[
    ["respawnBaseGroup", ecs.TYPE_INT],
    ["team", ecs.TYPE_INT],
    ["active", ecs.TYPE_BOOL],
    ["respawnbaseType", ecs.TYPE_STRING]
  ],
  comps_rq=["forceRespawnBasePriority"]
})

...
return [
  {
    ...
    actionOnReload = @(_state, cb) eventbus_subscribe_onehit(AUTH_STEAM, ah.status_cb(cb))
  }
  {
    id = go_login.id
  ...
  }
  {
    ...
    actionOnReload = @(_state, cb) eventbus_subscribe_onehit(STEAM_LINK, ah.status_cb(cb))
  }
]
